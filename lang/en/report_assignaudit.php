 ...
 */
 ...
 $string['nocoursesinlist'] = 'Cannot create an assignrange form without a list of valid courses.';
 $string['coursesinlistmustbestdclass'] = 'Cannot create an assignrange form when one of the courses passed was not an stdClass';
